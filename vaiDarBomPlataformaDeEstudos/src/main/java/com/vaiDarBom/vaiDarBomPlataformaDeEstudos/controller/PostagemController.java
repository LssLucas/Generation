...
public class PostagemController {
	...
	public ResponseEntity<List<Postagem>> GetByTitulo(@PathVariable String assunto)
	{
		return ResponseEntity.ok(repository.findAllByTituloContainingIgnoreCase(assunto));
	}
	@PostMapping
